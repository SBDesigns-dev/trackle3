...
App.prototype.displayScore = function () {
  ...
  const shareText = `I just played Trackle™ and named ${score} DLR stations! You can play Trackle™ too:`;
  const shareData = {
    title: "Trackle™",
    text: shareText,
...
App.prototype.winMessage = function () {
  alert(
    "Well done! You found all " +
      this.placeList.length +
      " DLR, Cable Car and Elizabeth Line stations."
  );
};
